$(document).ready(function () {
	...
	if ($.cookie("background")) {
		if ($.cookie("box")) {
			$("body").css({
				"background-image": "url(Theme/img/bg/" + $.cookie("background") + ")",
			});
		}
	}
	$(document).on("click", ".demo .background", function (e) {
		e.preventDefault();
		if ($.cookie("box")) {
			$.cookie("background", $(this).data("background"), {
				expires: 7,
				path: "/",
			});
			$("body").css({
				"background-image":
					"url(Theme/img/bg/" + $(this).data("background") + ")",
			});
		}
	});
	...
	var html =
		...
		'<a href="#" class="color" data-color="yellow.css" style="background-color:#ffc500"></a>' +
		...
		'<a href="#" class="color" data-color="blue.css" style="background-color:#A7C7E7"></a>' +
		'<a href="#" class="color" data-color="purple.css" style="background-color:#BF55EC"></a>' +
		'<a href="#" class="color" data-color="turquoise.css" style="background-color:#3CC"></a>' +
		...
		'<a href="#" class="color" data-color="orange.css" style="background-color:#f62459"></a>' +
